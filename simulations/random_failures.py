...
# Remove corresponding RIDTT nodes
...
# ---------------------------------------------------
# EDGE GROUPS (FROM FAILED GRAPH)
# ---------------------------------------------------

tree1_edges = [
    (u, v)
    for u, v, d in G_failed.edges(data=True)
...
plt.title(
    f"RIDTT Topology After Failure of Logical Node {failed_node}",
    fontsize=16
)
...
filename = f"ridtt_failure_node_{failed_node}.png"
